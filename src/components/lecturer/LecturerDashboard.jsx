  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between pb-5 border-b border-slate-200 gap-4 mb-5">
        <div>
          <div className="inline-flex items-center gap-1.5 bg-emerald-50 text-emerald-800 text-sm font-semibold px-2.5 py-0.5 rounded border border-emerald-200 mb-1.5">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="pl-7 pr-3 py-1.5 text-sm bg-white border border-slate-300 rounded focus:outline-none focus:border-[#003DA5]"
          />
        </div>
      </div>
      ...
      <div className="bg-white rounded-lg border border-slate-200 overflow-hidden">
        <div className="p-4 border-b border-slate-200 flex items-center justify-between">
          <h3 className="font-bold text-base text-slate-800">Assigned Student Submissions</h3>
          <span className="text-sm text-slate-500 font-medium">{filteredStudents.length} Candidates Assigned</span>
        </div>
                ...
                <tr key={student.id} className="hover:bg-slate-50 transition">
                  ...
                  <td className="p-3 text-right">
                    <button
                      ...
                      className={`px-3 py-1 rounded text-sm font-semibold transition inline-flex items-center gap-1.5 ${
                        student.marks 
